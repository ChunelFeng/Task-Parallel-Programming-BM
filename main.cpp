...
#include "CGraph-lite-package/CGraph-lite-BM.h"
...
BENCHMARK(CGRAPHLITE_32PARALLEL_8thds_BM);
...
BENCHMARK(CGRAPHLITE_32SERIAL_1thds_BM);
...
BENCHMARK(CGRAPHLITE_SIMPLE_2thds_BM);
...
BENCHMARK(CGRAPHLITE_8x8FC_8thds_BM);
